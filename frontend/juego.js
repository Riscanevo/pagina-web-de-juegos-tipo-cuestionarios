...
const preguntas = [
    ...
    },
    {
        id: 8,
        categoria: "musica",
        titulo: "¿Cuál de los siguientes géneros musicales nació en Cartagena? ",
        opcionA: "Vallenato",
        opcionB: "Champeta",
        opcionC: "Salsa",
        opcionD: "Merengue",
    ...
    },
    {
        id: 9,
        categoria: "musica",
        titulo: "¿Cuál de estos artistas colombianos es reconocido por popularizar la música salsa?",
        opcionA: "Shakira",
        opcionB: "Juanes",
        opcionC: "Joe Arroyo",
        opcionD: "Carlos Vives",
        correcta: "c"
    },
    {
        id: 10,
        categoria: "musica",
        titulo: "¿Quién es conocido como el Cantor de Cantores en la música vallenata?",
        opcionA: "Jorge Celedón",
        opcionB: "Diomedes Díaz",
        opcionC: "Silvestre Dangond",
        opcionD: "Carlos Vive",
        correcta: "b"
    },
    {
        id: 11,
        categoria: "deportes",
        titulo: "¿Cuál es el equipo más exitoso en la historia de la liga colombiana?",
        opcionA: " Atlético Nacional",
        opcionB: "Millonarios",
        opcionC: "Independiente Santa Fe",
        opcionD: "América de Cali",
        correcta: "a"
    },
    {
        id: 12,
        categoria: "deportes",
        titulo: "¿Qué equipo de fútbol colombiano ha ganado la Copa Libertadores en múltiples ocasiones?",
        opcionA: "Junior de Barranquilla",
        opcionB: "Atlético Nacional",
        opcionC: "Independiente Medellín",
        opcionD: "Once Caldas",
        correcta: "b"
    },
    {
    ...
    },
    {
        id: 15,
        categoria: "deportes",
        titulo: "¿Cuál es el nombre del evento ciclístico que recorre diferentes regiones de Colombia y se celebra anualmente?",
        opcionA: "Vuelta a España",
        opcionB: "Giro de Italia",
        opcionC: "Vuelta a Colombia",
        opcionD: "Tour de Francia",
        correcta: "c"
    },
    {
        id: 16,
    ...
    },
    {
        id: 28,
        categoria: "peliculas",
        titulo: "En Rápidos y Furiosos, ¿en qué ciudad principal se desarrolla la mayoría de las películas?",
        opcionA: "Tokio",
        opcionB: "Los Angeles",
        opcionC: "Texas",
        opcionD: "Miami",
    ...
    },
    {
        id: 29,
        categoria: "peliculas",
        titulo: "En Transformers, ¿cuál es el nombre del planeta natal de los Autobots y Decepticons?",
        opcionA: "Cybertron",
        opcionB: " Earthtron",
        opcionC: "Jupiter",
        opcionD: "Unicron",
    ...
    },
    {
        id: 30,
        categoria: "peliculas",
        titulo: "En Dragon Ball, ¿qué objeto mágico es necesario para viajar alrededor del mundo en poco tiempo?        ",
        opcionA: "La Nube Voladora",
        opcionB: "La Cápsula de Transporte",
        opcionC: "El Radar Dragon",
        opcionD: "Ratatouille",
        correcta: "a"
    }
]
...
function cargarSiguientePregunta(num) {
    ...
    // AQUI ES DONDE AGREGO LA FUNCION QUE MANEJA EL CLICK DE CADA BOTON//
    botonesRespuesta.forEach(opcion => {
